        ...
        try {
            ...
            try {
                ...
                if(session == null){
                    ...
                    if (projectID.equals("")) out.print("");//redundant error check for blank username
                    else{
                        ArrayList<Task> taskList = new ArrayList<Task>();
                        conn = this.manager.getConnection();
                        String query = "SELECT project,title,description,priority,completed,begisAt,endedAt,duration FROM Tasks as t1 WHERE t1.project = ? ";
